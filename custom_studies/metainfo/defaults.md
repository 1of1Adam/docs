...
extracted_at: "2025-06-22T09:29:07.441Z"
---

# Custom Studies Defaults`defaults` is a field in [Metainfo](https://www.tradingview.com/charting-library-docs/latest/custom_studies/metainfo/) of Custom Study, containing an object with settings that are applied when user clicks `Apply Defaults`.
