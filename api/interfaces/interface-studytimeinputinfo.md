---
title: "Interface: StudyTimeInputInfo | Advanced Charts Documentation"
url: "https://www.tradingview.com/charting-library-docs/latest/api/interfaces/Charting_Library.StudyTimeInputInfo"
extracted_at: "2025-06-22T09:48:06.883Z"
---

- [](/charting-library-docs/)- Interfaces- StudyTimeInputInfoOn this page# Interface: StudyTimeInputInfo[Charting Library](https://www.tradingview.com/charting-library-docs/latest/api/modules/Charting_Library).StudyTimeInputInfo
...
### type[​](#type)
• `Readonly` type: [`Time`](https://www.tradingview.com/charting-library-docs/latest/api/enums/Charting_Library.StudyInputType#time)
