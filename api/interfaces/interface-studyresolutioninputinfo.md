---
title: "Interface: StudyResolutionInputInfo | Advanced Charts Documentation"
url: "https://www.tradingview.com/charting-library-docs/latest/api/interfaces/Charting_Library.StudyResolutionInputInfo"
extracted_at: "2025-06-22T09:47:28.950Z"
---

- [](/charting-library-docs/)- Interfaces- StudyResolutionInputInfoOn this page# Interface: StudyResolutionInputInfo[Charting Library](https://www.tradingview.com/charting-library-docs/latest/api/modules/Charting_Library).StudyResolutionInputInfo
...
### defval[​](#defval)
• `Readonly` defval: [`ResolutionString`](https://www.tradingview.com/charting-library-docs/latest/api/modules/Charting_Library#resolutionstring)
...
### isMTFResolution[​](#ismtfresolution)
• `Optional` `Readonly` isMTFResolution: `boolean`
...
### type[​](#type)
• `Readonly` type: [`Resolution`](https://www.tradingview.com/charting-library-docs/latest/api/enums/Charting_Library.StudyInputType#resolution)
...
- [Hierarchy](#hierarchy)- [Properties](#properties)[confirm](#confirm)- [defval](#defval)- [hideWhenPlotsHidden](#hidewhenplotshidden)- [id](#id)- [isHidden](#ishidden)- [isMTFResolution](#ismtfresolution)- [name](#name)- [options](#options)- [optionsTitles](#optionstitles)- [type](#type)- [visible](#visible)