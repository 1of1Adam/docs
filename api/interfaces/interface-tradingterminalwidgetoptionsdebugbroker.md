...
url: "https://www.tradingview.com/charting-library-docs/latest/api/interfaces/Charting_Library.TradingTerminalWidgetOptions#debug_broker"
extracted_at: "2025-06-22T09:50:52.758Z"
---

- [](/charting-library-docs/)- Interfaces- TradingTerminalWidgetOptionsOn this page# Interface: TradingTerminalWidgetOptions[Charting Library](https://www.tradingview.com/charting-library-docs/latest/api/modules/Charting_Library).TradingTerminalWidgetOptions
...
```
const jsonNewsApiUrl = 'https://www.example.com';new TradingView.widget({    // ...    news_provider: function getNews(symbol, callback) {        const requestUrl = new URL('/news/', jsonNewsApiUrl);        requestUrl.searchParams.append('symbol', symbol);        fetch(requestUrl)            .then(res => res.json())            .then(json => {                callback({                    newsItems: json,                });            });    }});
```
...
```
rss_news_feed: {    "default": {        url: "https://articlefeeds.nasdaq.com/nasdaq/symbols?symbol={SYMBOL}",        name: "NASDAQ"    }}
```

### rss_news_title[​](#rss_news_title)
...
### trading_customization[​](#trading_customization)
...
NameTypeDescription`host`[`IBrokerConnectionAdapterHost`](https://www.tradingview.com/charting-library-docs/latest/api/interfaces/Charting_Library.IBrokerConnectionAdapterHost)Trading Host
#### Returns[​](#returns-1)
...
```- [Hierarchy](#hierarchy)- [Properties](#properties)[additional_symbol_info_fields](#additional_symbol_info_fields)- [auto_save_delay](#auto_save_delay)- [autosize](#autosize)- [brokerConfig](#brokerconfig)- [broker_config](#broker_config)- [charts_storage_api_version](#charts_storage_api_version)- [charts_storage_url](#charts_storage_url)- [client_id](#client_id)- [compare_symbols](#compare_symbols)- [container](#container)- [context_menu](#context_menu)- [custom_chart_description_function](#custom_chart_description_function)- [custom_css_url](#custom_css_url)- [custom_font_family](#custom_font_family)- [custom_formatters](#custom_formatters)- [custom_indicators_getter](#custom_indicators_getter)- [custom_themes](#custom_themes)- [custom_timezones](#custom_timezones)- [custom_translate_function](#custom_translate_function)- [datafeed](#datafeed)- [debug](#debug)- [debug_broker](#debug_broker)- [disabled_features](#disabled_features)- [drawings_access](#drawings_access)- [enabled_features](#enabled_features)- [favorites](#favorites)- [fullscreen](#fullscreen)- [header_widget_buttons_mode](#header_widget_buttons_mode)- [height](#height)- [image_storage_adapter](#image_storage_adapter)- [interval](#interval)- [library_path](#library_path)- [load_last_chart](#load_last_chart)- [loading_screen](#loading_screen)- [locale](#locale)- [news_provider](#news_provider)- [numeric_formatting](#numeric_formatting)- [overrides](#overrides)- [restConfig](#restconfig)- [rss_news_feed](#rss_news_feed)- [rss_news_title](#rss_news_title)- [save_load_adapter](#save_load_adapter)- [saved_data](#saved_data)- [saved_data_meta_info](#saved_data_meta_info)- [settings_adapter](#settings_adapter)- [settings_overrides](#settings_overrides)- [snapshot_url](#snapshot_url)- [studies_access](#studies_access)- [studies_overrides](#studies_overrides)- [study_count_limit](#study_count_limit)- [symbol](#symbol)- [symbol_search_complete](#symbol_search_complete)- [symbol_search_request_delay](#symbol_search_request_delay)- [theme](#theme)- [time_frames](#time_frames)- [time_scale](#time_scale)- [timeframe](#timeframe)- [timezone](#timezone)- [toolbar_bg](#toolbar_bg)- [trading_customization](#trading_customization)- [user_id](#user_id)- [widgetbar](#widgetbar)- [width](#width)- [Methods](#methods)[broker_factory](#broker_factory)