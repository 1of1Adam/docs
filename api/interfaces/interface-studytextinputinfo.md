---
title: "Interface: StudyTextInputInfo | Advanced Charts Documentation"
url: "https://www.tradingview.com/charting-library-docs/latest/api/interfaces/Charting_Library.StudyTextInputInfo"
extracted_at: "2025-06-22T09:47:59.843Z"
---

- [](/charting-library-docs/)- Interfaces- StudyTextInputInfoOn this page# Interface: StudyTextInputInfo[Charting Library](https://www.tradingview.com/charting-library-docs/latest/api/modules/Charting_Library).StudyTextInputInfo
...
### type[​](#type)
• `Readonly` type: [`Text`](https://www.tradingview.com/charting-library-docs/latest/api/enums/Charting_Library.StudyInputType#text)
