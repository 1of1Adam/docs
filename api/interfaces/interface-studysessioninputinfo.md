...
url: "https://www.tradingview.com/charting-library-docs/latest/api/interfaces/Charting_Library.StudySessionInputInfo"
extracted_at: "2025-06-22T09:47:34.525Z"
---

- [](/charting-library-docs/)- Interfaces- StudySessionInputInfoOn this page# Interface: StudySessionInputInfo[Charting Library](https://www.tradingview.com/charting-library-docs/latest/api/modules/Charting_Library).StudySessionInputInfo
...
### type[​](#type)
• `Readonly` type: [`Session`](https://www.tradingview.com/charting-library-docs/latest/api/enums/Charting_Library.StudyInputType#session)
