---
title: "Interface: ActionDescriptionWithCallback | Advanced Charts Documentation"
url: "https://www.tradingview.com/charting-library-docs/latest/api/interfaces/Broker.ActionDescriptionWithCallback"
extracted_at: "2025-06-22T09:53:18.976Z"
---

- [](/charting-library-docs/)- Interfaces- ActionDescriptionWithCallbackOn this page# Interface: ActionDescriptionWithCallback[Broker](https://www.tradingview.com/charting-library-docs/latest/api/modules/Broker).ActionDescriptionWithCallback
...
### action[​](#action)
• action: (`a?`: [`ActionDescription`](https://www.tradingview.com/charting-library-docs/latest/api/interfaces/Broker.ActionDescription)) => `void`
...
NameType`a?`[`ActionDescription`](https://www.tradingview.com/charting-library-docs/latest/api/interfaces/Broker.ActionDescription)
Returns[​](#returns)
`void`
...
- [Hierarchy](#hierarchy)- [Properties](#properties)[action](#action)- [checkable](#checkable)- [checked](#checked)- [checkedStateSource](#checkedstatesource)- [enabled](#enabled)- [externalLink](#externallink)- [icon](#icon)- [separator](#separator)- [shortcut](#shortcut)- [text](#text)- [tooltip](#tooltip)