---
title: "Interface: StudyColorInputInfo | Advanced Charts Documentation"
url: "https://www.tradingview.com/charting-library-docs/latest/api/interfaces/Charting_Library.StudyColorInputInfo"
extracted_at: "2025-06-22T09:46:04.735Z"
---

- [](/charting-library-docs/)- Interfaces- StudyColorInputInfoOn this page# Interface: StudyColorInputInfo[Charting Library](https://www.tradingview.com/charting-library-docs/latest/api/modules/Charting_Library).StudyColorInputInfo
...
### type[​](#type)
• `Readonly` type: [`Color`](https://www.tradingview.com/charting-library-docs/latest/api/enums/Charting_Library.StudyInputType#color)
