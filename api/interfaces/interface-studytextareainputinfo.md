---
title: "Interface: StudyTextareaInputInfo | Advanced Charts Documentation"
url: "https://www.tradingview.com/charting-library-docs/latest/api/interfaces/Charting_Library.StudyTextareaInputInfo"
extracted_at: "2025-06-22T09:48:04.943Z"
---

- [](/charting-library-docs/)- Interfaces- StudyTextareaInputInfoOn this page# Interface: StudyTextareaInputInfo[Charting Library](https://www.tradingview.com/charting-library-docs/latest/api/modules/Charting_Library).StudyTextareaInputInfo
...
### type[​](#type)
• `Readonly` type: [`Textarea`](https://www.tradingview.com/charting-library-docs/latest/api/enums/Charting_Library.StudyInputType#textarea)
