---
title: "Interface: StudyUpColorerPlotInfo | Advanced Charts Documentation"
url: "https://www.tradingview.com/charting-library-docs/latest/api/interfaces/Charting_Library.StudyUpColorerPlotInfo"
extracted_at: "2025-06-22T09:48:08.658Z"
---

- [](/charting-library-docs/)- Interfaces- StudyUpColorerPlotInfoOn this page# Interface: StudyUpColorerPlotInfo[Charting Library](https://www.tradingview.com/charting-library-docs/latest/api/modules/Charting_Library).StudyUpColorerPlotInfo
...
### type[​](#type)
• `Readonly` type: [`UpColorer`](https://www.tradingview.com/charting-library-docs/latest/api/enums/Charting_Library.StudyPlotType#upcolorer)
