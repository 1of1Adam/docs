---
title: "Using the library with online code playgrounds | Advanced Charts Documentation"
url: "https://www.tradingview.com/charting-library-docs/latest/getting_started/Online-Editors"
extracted_at: "2025-06-22T09:14:01.153Z"
---

# Using the library with online code playgroundsIt is possible to use our hosted library bundles on a few select code
...
See
[Hosting Library Cross Origin](https://www.tradingview.com/charting-library-docs/latest/getting_started/Hosting-Library-Cross-Origin)
...
Select one of the domains listed above depending on whether you are creating
an example for the Advanced Charts or the Trading Platform. The following
steps will use the `https://charting-library.tradingview-widget.com` domain.

Within the head of your html file you can load the standalone versions of the
...
The `library_path` property in the widget constructor options should be set
...
[charting_library GitHub repository](https://github.com/tradingview/charting_library)
 🔐 (access is [restricted](https://www.tradingview.com/charting-library-docs/latest/getting_started/quick-start#getting-access)) on the `master` branch. If you would like to use a specific version then you
...
Please note that
the [demo charts and study template storage server](https://www.tradingview.com/charting-library-docs/latest/saving_loading/#using-demo-charts-and-study-templates-storage) (`http://saveload.tradingview.com`)
...
[Themed Advanced Charts](https://glitch.com/edit/#!/charting-library-themed-starter)
...
- [Advanced Charts](https://glitch.com/edit/#!/charting-library-starter)
- [Trading Platform](https://glitch.com/edit/#!/trading-terminal-starter)
- [Themed Advanced Charts](https://glitch.com/edit/#!/charting-library-themed-starter)